...
const Interface = function (data) {
  if (typeof data === 'undefined') {
    if (window.XMLHttpRequest) data = {XMLHttpRequest: window.XMLHttpRequest};
    else if (isNode()) data = {http: require('http'), https: require('https')};
  }
  ...
  */
  ...
  method('init')(); // TODO depricated to be removed
  ...
  method('list')(fail, legacy);
  method('burn')(fail, legacy);
