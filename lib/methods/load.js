...
/**
   ...
   * );
   */
exports.load = (storage, fail, legacy, hasHost) => function (data, dataCallback, errorCallback, progressCallback) {
  if (typeof data !== 'object') return fail('Expected an object.', errorCallback);
    ...
    const useFallbackCallback = error => {
      ...
      if (typeof error === 'object' && Object.keys(error).length === 0) return fail('Could not retrieve file', errorCallback);
