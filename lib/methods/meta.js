/**
   ...
   * );
   */
exports.meta = (storage, fail, legacy) => function (data, dataCallback, errorCallback, progressCallback) {
  if (typeof data !== 'object' || data === null) return fail('Expected an object.', errorCallback);
    ...
    // TODO use legacy
    return this.rout({host: data.host, query: '/e/storage/meta/' + encodeURIComponent(data.key), channel: data.channel, meta: data.meta}, dataCallback, errorCallback, progressCallback);
  }
};
