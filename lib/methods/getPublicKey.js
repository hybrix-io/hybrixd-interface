/**
   ...
   * );
   */
exports.getPublicKey = (assets, fail, hasSession) => function (data, dataCallback, errorCallback) {
  ...
  return this.addAsset(data, () => dataCallback(assets[data.symbol].data.publickey), errorCallback);
};
