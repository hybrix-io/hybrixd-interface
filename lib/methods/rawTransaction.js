...
const assetHasBeenAdded = (assets, data, dataCallback, errorCallback, progressCallback) => function () {
  const followUp = assetHasBeenRefreshed(assets, data, dataCallback, errorCallback, progressCallback).bind(this);
  if (this.validate === false) return followUp();
  else {
    return this.refreshAsset({symbol: data.symbol},
      followUp,
      errorCallback,
      progressCallback
    );
...
const assetHasBeenRefreshed = (assets, data, dataCallback, errorCallback, progressCallback) => function () {
...
/**
   ...
   * );
   */
exports.rawTransaction = (assets, fail, hasSession) => function (data, dataCallback, errorCallback, progressCallback) {
